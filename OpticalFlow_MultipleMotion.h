...
int IRLS_MultipleMotion_OpticalFlow(VECTOR_2D *u, VECTOR_2D *Img_g, double *Img_t, SIZE size_img, double lambdaD, double lambdaS, double sigmaD, double sigmaS, int IterMax, double ErrorMinThreshold, int level);
void LevelDown(VECTOR_2D *u_l, SIZE size_l, VECTOR_2D *u_lp1, SIZE size_lp1);
...
int MultipleMotion_write(VECTOR_2D *u, SIZE size, const char *filename);
