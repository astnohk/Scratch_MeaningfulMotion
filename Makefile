...
IMGCLASS_CFILES = ImgClass/BlockMatching.cpp ImgClass/Color.cpp ImgClass/CrossCorrelation.cpp ImgClass/ImgStatistics.cpp ImgClass/Lab.cpp ImgClass/RGB.cpp ImgClass/Segmentation.cpp
...
IMGCLASS_OFILES = BlockMatching.o Color.o CrossCorrelation.o ImgStatistics.o Lab.o RGB.o Segmentation.o
