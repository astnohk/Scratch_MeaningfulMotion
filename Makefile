...
IMGCLASS_CFILES = ImgClass/CrossCorrelation.cpp ImgClass/ImgStatistics.cpp ImgClass/Lab.cpp ImgClass/MotionCompensation.cpp ImgClass/RGB.cpp
...
IMGCLASS_OFILES = CrossCorrelation.o ImgStatistics.o Lab.o MotionCompensation.o RGB.o
