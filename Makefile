...
IMGCLASS_CFILES = ImgClass//BlockMatching.cpp ImgClass/CrossCorrelation.cpp ImgClass/ImgStatistics.cpp ImgClass/Lab.cpp ImgClass/RGB.cpp
...
IMGCLASS_OFILES = BlockMatching.o CrossCorrelation.o ImgStatistics.o Lab.o RGB.o
